<template>
  <div class="relative min-h-screen w-full bg-[url('/img/cislago-bg.jpeg')] bg-cover bg-no-repeat bg-fixed">
    ...
    <div class="relative container mx-auto py-20 px-4 sm:px-6">
      <h2 class="text-3xl font-semibold text-white text-center mb-12">Le Attività della Notte Bianca</h2>
...
const { getAllUnsorted } = useActivities();

onMounted(() => {
  activities.value = getAllUnsorted.value;
  loading.value = false;
});
</script>
