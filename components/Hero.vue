<template>
  <section class="relative min-h-screen w-full bg-indigo-950 bg-[url('/img/cislago-bg.jpeg')] bg-cover bg-no-repeat">
    ...
    <div class="grid min-h-screen px-8">
      <div class="container relative z-10 my-auto mx-auto grid place-items-center text-center" role="region">
        ...
        <p class="text-xl text-white mt-1 mb-12 lg:max-w-2xl">
          Musica, spettacoli e negozi aperti fino a tardi<br/>
